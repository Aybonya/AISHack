...
const navigation = [
  ...
  { href: "/attendance", label: "Посещаемость", icon: Activity },
    ...
    <div className="flex h-full flex-col items-center justify-between py-4">
      <div className="flex flex-col items-center gap-3">
        ...
        {navigation.map(({ href, label, icon: Icon }) => {
          ...
          const badge = href === "/chats" ? unreadCount : 0;
          ...
          return (
            ...
            >
              {active ? (
                <span className="absolute left-0 top-1/2 h-6 w-1 -translate-y-1/2 rounded-r-full bg-[#00a884]" />
              ) : null}
